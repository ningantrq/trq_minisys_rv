...
#
# Script generated by Vivado on Sat Jan 03 14:20:59 +0800 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ip_multiplier.sh
...
#
# Usage        : ip_multiplier.sh
#                ip_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ip_multiplier.sh [-reset_run]
#                ip_multiplier.sh [-reset_log]
#                ip_multiplier.sh [-help]
#
...
#                script (type 'ip_multiplier.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ip_multiplier.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ip_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ip_multiplier xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ip_multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ip_multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ip_multiplier.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ip_multiplier.sh [-help]\n\
Usage: ip_multiplier.sh [-step]\n\
Usage: ip_multiplier.sh [-lib_map_path]\n\
Usage: ip_multiplier.sh [-reset_run]\n\
Usage: ip_multiplier.sh [-reset_log]\n\
Usage: ip_multiplier.sh [-keep_index]\n\
Usage: ip_multiplier.sh [-noclean_files]\n\n\
